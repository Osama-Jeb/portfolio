        ...
        <section className="min-h-[90vh] relative" id="hero">
            ...
            <div className="flex items-center justify-around w-full">
                ...
                <div className="text-center space-y-6 p-3">
                    {/* intro */}
                    <h1 className="text-2xl lg:text-5xl font-bold">Hi 👋, I'm Oussama Jebrane</h1>
                    <br />
                    <div>
                        <div className="flex gap-1">
                            <h1 className="text-4xl lg:text-7xl font-bold text-alpha">FULLSTACK WEB DEVELOPER
                            </h1>
                            <div className="w-[4px] h-[50px] bg-alpha animate-bounce"></div>
                        </div>
                        <br />
                        <h3 className="text-xl lg:text-2xl font-bold">I conceive and build intuitive websites and mobile applications.</h3>
                    </div>
